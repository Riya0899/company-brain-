...
def render_chips(questions, key_prefix):
    """Render a row of clickable question chips. Returns the clicked question, if any."""
    clicked = None
...
def render():
    ...
    if not st.session_state.messages:
        ...
        <div style="text-align:center;padding:28px 0">
          ...
          <div style="font-size:16px;color:#fff;font-weight:600">What would you like to know?</div>
        </div>
        """, unsafe_allow_html=True)
    ...
    if chip_query:
        query = chip_query  # chip click overrides typed input
